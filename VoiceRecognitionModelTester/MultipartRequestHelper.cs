...
{
    /// <summary>
    /// Provides multiple functions to aid with fast file (in multipart requests) transfer
    /// Taken from https://dotnetcoretutorials.com/2017/03/12/uploading-files-asp-net-core/
    /// </summary>
    public static class MultipartRequestHelper
    {
        ...
        {
            //var boundary = HeaderUtilities.RemoveQuotes(contentType.Boundary);// .NET Core <2.0
